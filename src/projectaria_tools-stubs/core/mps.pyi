...
class ClosedLoopTrajectoryPose:
    ...
    transform_world_device: projectaria_tools.core.sophus.SE3d
...
class OpenLoopTrajectoryPose:
    ...
    session_uid: str
    tracking_timestamp: datetime.timedelta
    transform_odometry_device: projectaria_tools.core.sophus.SE3d
    utc_timestamp: datetime.timedelta
    def __init__(self, *args, **kwargs) -> None: ...
...
class StaticCameraCalibration:
    ...
    transform_world_cam: projectaria_tools.core.sophus.SE3d
    width: int
    def __init__(self, *args, **kwargs) -> None: ...
...
def get_eyegaze_point_at_depth(
    yaw_rads: float, pitch_rads: float, depth_m: float
) -> numpy.ndarray[numpy.float64[3, 1]]: ...
def read_closed_loop_trajectory(path: str) -> List[ClosedLoopTrajectoryPose]: ...
def read_eyegaze(path: str) -> List[EyeGaze]: ...
def read_global_point_cloud(
    path: str, compression: StreamCompressionMode
