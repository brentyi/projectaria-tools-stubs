...
class CameraCalibration:
    ...
    @overload
    def __init__(self, arg0: str, arg1: CameraModelType, arg2: numpy.ndarray[numpy.float64[m,1]], arg3: _core_pybinds.sophus.SE3d, arg4: int, arg5: int, arg6: Optional[float], arg7: float) -> None: ...
    ...
    def get_transform_device_camera(self) -> _core_pybinds.sophus.SE3d: ...
    def is_visible(self, camera_pixel: numpy.ndarray[numpy.float64[2,1]]) -> bool: ...
    def model_name(self) -> CameraModelType: ...
    def project(self, point_in_camera: numpy.ndarray[numpy.float64[3,1]]) -> Optional[numpy.ndarray[numpy.float64[2,1]]]: ...
    ...
    def unproject(self, camera_pixel: numpy.ndarray[numpy.float64[2,1]]) -> Optional[numpy.ndarray[numpy.float64[3,1]]]: ...
...
class DeviceCalibration:
    ...
    def get_magnetometer_calib(self, label: str) -> Optional[MagnetometerCalibration]: ...
    ...
    def get_transform_cpf_sensor(self, label: str, get_cad_value: bool = ...) -> Optional[_core_pybinds.sophus.SE3d]: ...
    def get_transform_device_cpf(self) -> _core_pybinds.sophus.SE3d: ...
    def get_transform_device_sensor(self, label: str, get_cad_value: bool = ...) -> Optional[_core_pybinds.sophus.SE3d]: ...

class ImuCalibration:
    def __init__(self, arg0: str, arg1: numpy.ndarray[numpy.float64[3,3]], arg2: numpy.ndarray[numpy.float64[3,1]], arg3: numpy.ndarray[numpy.float64[3,3]], arg4: numpy.ndarray[numpy.float64[3,1]], arg5: _core_pybinds.sophus.SE3d) -> None: ...
    def get_label(self) -> str: ...
    def get_transform_device_imu(self) -> _core_pybinds.sophus.SE3d: ...
