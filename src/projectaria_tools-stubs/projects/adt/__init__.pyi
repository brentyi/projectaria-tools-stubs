...
class Aria3dPose:
    ...
    transform_scene_device: projectaria_tools.core.sophus.SE3d
...
class AriaDigitalTwinDataProvider:
    ...
    def get_aria_camera_calibration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> Optional[projectaria_tools.core.calibration.CameraCalibration]: ...
    ...
    def get_aria_transform_device_camera(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.sophus.SE3d: ...
...
class BoundingBox3dData:
    ...
    transform_scene_object: projectaria_tools.core.sophus.SE3d
    def __init__(self) -> None: ...
